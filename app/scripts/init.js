$( document ).ready(function(){
  ...
  var sectionTop = ($(".contacts__wrap").length > 0)?sectionTop = $(".contacts__wrap"): ($(".purple-top").length > 0) ? sectionTop = $(".section-top.purple-top"): sectionTop = $(".section-top.inner-top");
